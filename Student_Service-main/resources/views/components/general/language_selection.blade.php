<div>
    <button id="language-dropdown-button" type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
    ...
    <!-- Dropdown -->
    <div class="hidden fixed top-10 right-20 z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700" id="language-dropdown-menu">
...
<script>
    document.querySelector("#language-dropdown-button").addEventListener('click',function(){
            if(document.querySelector("#language-dropdown-menu").classList.contains("hidden")){
                document.querySelector("#language-dropdown-menu").classList.remove("hidden")
            }
            else{
                document.querySelector("#language-dropdown-menu").classList.add("hidden")
            }
        });
</script>