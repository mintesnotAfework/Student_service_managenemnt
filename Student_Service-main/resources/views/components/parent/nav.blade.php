        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                <a href="#" class="flex ms-2 md:me-24">
                    ...
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Student Service and Managenment</span>
                </a>
            </div>
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        <div>
                            ...
                            <img class="w-8 h-8 rounded-full" src="{{asset('login_background.jpg')}}" alt="user photo">
                            </button>
                        </div>
                        <div id="open_user_hidden" class="fixed right-0 top-8 z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                            <a href="#" >
