            ...
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto p-10 lg:py-0">
                ...
                <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" method="POST" action="{{route("admin.admin.store")}}" enctype="multipart/form-data">
                            @csrf
                            @method("POST")
                            <div>
                            ...
                            <button type="submit" class="w-full text-grey-100 bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create an Admin account</button>
                        </form>
                    </div>
                </div>
            </div>
