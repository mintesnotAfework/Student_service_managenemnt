<x-admin_layout>
    <div>
        <div class="flex justify-content-center flex-col max-w-xl p-8 shadow-sm rounded-xl md:ml-30 lg:p-12 dark:bg-gray-900 dark:text-gray-50">
            <div class="flex flex-col w-full">
                ...
                <div class="flex flex-col mt-4">
                    <div class="flex items-center space-x-1">
                        ...
                        <div class="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-300">
                            <div class="dark:bg-orange-500 h-4 w-5/6"></div>
                        </div>
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <div class="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-300">
                            <div class="dark:bg-orange-500 h-4 w-4/6"></div>
                        </div>
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <div class="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-300">
                            <div class="dark:bg-orange-500 h-4 w-3/6"></div>
                        </div>
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <div class="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-300">
                            <div class="dark:bg-orange-500 h-4 w-2/6"></div>
                        </div>
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <div class="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-300">
                            <div class="dark:bg-orange-500 h-4 w-1/6"></div>
                        </div>
